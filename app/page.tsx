...
// Lazy load heavy animation components - Use optimized version
const AnimatedContent = dynamic(
  () => import("@/components/reactbits/AnimatedContentOptimized"),
  {
    ssr: false,
...
const FeatureCard = memo(
  ({ feature, index }: { feature: any; index: number }) => (
    <AnimatedContent distance={80} delay={index * 0.1}>
