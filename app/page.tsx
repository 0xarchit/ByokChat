...
export default function LandingPage() {
  const features = [
    ...
    },
    {
      ...
      title: "Privacy First",
      description:
        "Your conversations stay local. No data sent to our servers. Complete privacy and security guaranteed.",
    ...
    },
    {
      ...
      description:
        "Direct API connections mean faster responses. No middleman, no delays. Pure performance.",
    ...
    },
    {
      ...
      description:
        "Switch between OpenAI, Claude, Gemini, and more. One interface for all your AI needs.",
    ...
    },
    {
      ...
      description:
        "Open source and customizable. Built with modern tech stack: Next.js, TypeScript, and Tailwind CSS.",
    ...
    },
    {
      ...
      description:
        "Markdown support, syntax highlighting, and mermaid diagrams. Professional-grade conversations.",
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <AnimatedContent distance={80} duration={1} delay={0.5}>
            <p className="text-lg sm:text-xl text-gray-300 mb-10 leading-relaxed px-4">
              ...
              conversations. Use your own API keys, keep your data private, and
              enjoy unlimited conversations without any middleman.
            </p>
          </AnimatedContent>
